...
*/	private Scanner scanner;
	...
	protected PrintWriter createWriter(String outdir) throws IOException {  //2.1
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(
				outdir, "emailable-report-Build Summary" + ".html"))));
	}
	...
	public void testCaseNo() {
		m_out.println(
				" </br></br><br><table width='350px' height='30px' border='1' align='left'><tbody><tr colspan='2'><td bgcolor='#0088cc' colspan='2'><h3><center><font color='white'>Build Summary</font></center></h3></td></tr><tr><td><b>"
				+ "Passed Test cases</b>   </td> <td> <center><b>"
						...
						+ "</b></center> </td></tr><tr bgcolor='skyblue'><td> <b>Total Test Cases </b>  </td><td> <center><b>" + (failedcount+passed+skipped)
...
//				boolean wantsMinimalOutput = result.getStatus() == ITestResult.SUCCESS;
	...
	protected void startHtml(PrintWriter out) {  //3.1
		...
		out.println("<title>Build Summary</title>");
